 ...
 * Description: magic nnumbers are separated by spaces
 */
void print_magic(unsigned char *e_ident)
{
	int index;
...
/**
 * print_osabi - prints the OS/ABI of an ELF headr
 * @e_ident: a pointer to an array containing the ELF version
 */
void print_osabi(unsigned char *e_ident)
{
...
/**
 * print_entry - prints the entry point of an ELF headedr
...
/**
 * main - displays the informatio contained in the ELF header
 * at the start of an ELF file
 * @argc: the number of arguments supplied to the program
 * @argv: an array of pointers to the arguments
 * Return: 0 on success
 * Descriptin: if the file is not an ELF file or the function fails
 * exit code 98
 */
